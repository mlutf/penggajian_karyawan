        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                ...
                <li>
                        ...
                        <a href="absen"> <i class="menu-icon fa fa-fire"></i>Absen </a>
                        <a href="karyawan"> <i class="menu-icon fa fa-id-badge"></i>karyawan </a>
                        <a href="jabatan"> <i class="menu-icon fa fa-id-card-o"></i>Jabatan </a>
                        <a href="divisi"> <i class="menu-icon fa fa-bars"></i>Divisi </a>
                        <a href="rekap"> <i class="menu-icon fa fa-bars"></i>Rekap</a>
                    </li>
